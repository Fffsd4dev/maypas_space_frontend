...
const CurrencyRegistrationModal = ({ showCurrency, onHide, myCurrency, onSubmit }) => {
  ...
  }, [myCurrency, user?.tenant_id, user?.location_id]);
  ...
  }, [showCurrency, user?.tenant_id, user?.location_id]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = myCurrency
        ? `${import.meta.env.VITE_BACKEND_URL}/api/${tenantSlug}/currencies/update/${myCurrency.id}`
