...
const RoomRegistrationModal = ({ show, onHide, myRoom, onSubmit }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = myRoom
                ? `${import.meta.env.VITE_BACKEND_URL}/api/${tenantSlug}/floor/update/${myRoom.id}`
            ...
            <Modal.Body className="p-4">
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Button variant="primary" type="submit" className="w-100" disabled={isLoading}>
                        {isLoading ? <Spinner as="span" animation="border" size="sm" locations="status" aria-hidden="true" /> : myRoom ? "Update" : "Create"} Room
                    </Button>
                </Form>
            </Modal.Body>
        </Modal>
