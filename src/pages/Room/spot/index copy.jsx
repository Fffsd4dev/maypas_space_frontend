...
// import React, { useState, useEffect } from "react";
// import { Link } from "react-router-dom";
// import { Row, Col, Card, Button, Spinner, Form, Badge, Alert, Modal } from "react-bootstrap";
// import PageTitle from "../../../components/PageTitle";
// import { useAuthContext } from "@/context/useAuthContext.jsx";
// import Popup from "../../../components/Popup/Popup";
// import Table2 from "../../../components/Table2";
...
//     try {
//       const response = await fetch(
//         `${import.meta.env.VITE_BACKEND_URL}/api/${tenantSlug}/register`,
//         {
//           method: "POST",
//           headers: {
//             "Authorization": `Bearer ${user?.tenantToken}`,
...
//       // Set the newly created user as selected in the booking form
//       setBookingFormData(prev => ({
//         ...prev,
...
//             <div className="d-flex justify-content-end">
//               <Button variant="secondary" onClick={() => setShowAddUserModal(false)} className="me-2">
//                 Cancel
//               </Button>
//               <Button variant="primary" type="submit" disabled={isLoading}>
//                 {isLoading ? (
