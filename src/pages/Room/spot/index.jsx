...
//     // If we're updating start_time and end_time is before it, adjust end_time
//     if (field === 'start_time' && updatedDays[index].end_time && isBefore(updatedDays[index].end_time, value)) {
//       updatedDays[index].end_time = addDays(value, 1);
//     }
...
//       chosen_days: [
//         ...prev.chosen_days,
//         { day: "", start_time: null, end_time: null }
//       ]
//     }));
//   };
...
//       // Validate time ranges
//       for (const day of bookingFormData.chosen_days) {
//         if (isBefore(day.end_time, day.start_time)) {
//           throw new Error("End time must be after start time");
//         }
//       }
...
//         const start = parseISO(day.start_time);
//         const end = parseISO(day.end_time);
...
//                         <Form.Control
//                           type="text"
//                           value={day.day ? day.day.charAt(0).toUpperCase() + day.day.slice(1) : "Select start time first"}
//                           readOnly
//                         />
//                         <Form.Text className="text-muted">
//                           Automatically set from start time
//                         </Form.Text>
//                       </Form.Group>
//                     </Col>
//                   </Row>
