...
//       const result = await response.json();
//       console.log('Room details API response:', result);
      
//       if (result && result.data) {
//         setRoomDetails(result.data);
        
//         // Check if the response has spots data
//         if (result.data.spots && Array.isArray(result.data.spots)) {
//           console.log('Spots data:', result.data.spots);
          
//           // Create space cards from the spots array
...
//           setSpaceCards(cards);
//         } else {
//           console.warn('No spots array found in response, generating default cards');
//           const cards = generateSpaceCards(result.data.space_number);
//           setSpaceCards(cards);
//         }
//       } else {
...
//   // Handle book now click
//   const handleBookNowClick = (space) => {
//     console.log("Book Now clicked for spot:", space);
//     setSelectedSpace(space);
//     setBookingFormData({
//       type: "one-off",
//       chosen_days: [{
