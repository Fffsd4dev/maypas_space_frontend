    ...
    const fetchCompanyDetails = async () => {
      ...
      try {
        ...
        if (response.ok && result.data) {
          const { logo: fetchedLogo, company_name } = result.data;
          ...
          <div className="mb-4">
            ...
            <div className="row mt-3">
              <div className="col-md-6">
                ...
                <p className="mb-1">
                  <strong>Category:</strong> {space.space_category}
                </p>
                <p className="mb-1">
              ...
              <div className="col-md-6">
                ...
                <p className="mb-1">
                  ...
                  {formatCurrency(space.space_fee, currencySymbol)}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <p className="mb-1">
                    ...
                    {formatDateTime(invoice?.book_spot?.start_time)}
                  </p>
                </div>
                <div className="col-md-6">
                  <p className="mb-1">
          ...
          <table className="table">
            ...
            <tfoot>
              <tr>
                ...
                <td className="text-end fw-bold" style={{ color: brandColor, fontSize: "1.1em" }}>
