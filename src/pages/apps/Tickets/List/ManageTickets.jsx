...
const RequestedBy = ({
  ...
  return <>
      <Link to="#" className="text-body">
        <img src={row.original.requested_by.image} alt="" title="contact-img" className="rounded-circle avatar-xs" />
...
const AssigneeColumn = ({
  ...
  return <>
      <Link to="#">
        <img src={row.original.assignee} alt="" title="contact-img" className="rounded-circle avatar-xs" />
      </Link>
    </>;
};
  ...
  return <>
      <Card>
        <Card.Body>
          ...
          <Table columns={columns} data={ticketDetails} pageSize={10} sizePerPageList={sizePerPageList} isSortable={true} pagination={true} isSearchable={true} theadClass="table-light" searchBoxClass="mt-2 mb-3" />
        </Card.Body>
      </Card>
    </>;
};
