  ...
  return <React.Fragment>
      ...
      <Row>
        <Col md={6} xl={3}>
          ...
          prefix: "$"
        }} description="Total Revenue" stats="58947" icon="fe-heart" />
        </Col>
        <Col md={6} xl={3}>
          <StatisticsWidget variant="success" description="Today's Sales" stats="127" icon="fe-shopping-cart" />
        </Col>
        <Col md={6} xl={3}>
          <StatisticsWidget variant="info" description="Conversion" stats="0.58" counterOptions={{
          suffix: "%",
          decimals: 2
      ...
      <Row>
        <Col md={6} xl={3}>
          <StatisticsWidget variant="danger" description="Available Stores" stats="178" icon="fe-shopping-bag" />
        </Col>
        <Col md={6} xl={3}>
          <StatisticsWidget variant="secondary" description="Gitlab Commits" stats="289" icon="fe-gitlab" />
        </Col>
        <Col md={6} xl={3}>
          <StatisticsWidget variant="blue" description="Free Gifts" stats="1021" icon="fe-gift" />
        </Col>
        <Col md={6} xl={3}>
          <StatisticsWidget variant="pink" description="Paid Users" stats="154" counterOptions={{
          suffix: "k"
        }} icon="fe-user" />
        </Col>
      </Row>
      ...
      <Row>
        <Col md={6} xl={3}>
          <StatisticsWidget3 title="Income status" stats="31570" trend={{
          label: "Total income",
          value: "$22506",
          icon: "fa-caret-up",
          variant: "success",
        ...
        <Col md={6} xl={3}>
          <StatisticsWidget3 title="Sales Status" stats="683" trend={{
          label: "Total sales",
          value: "2398",
          icon: "fa-caret-down",
          variant: "danger",
        ...
        <Col md={6} xl={3}>
          <StatisticsWidget3 title="Recent Users" stats="3.2" trend={{
          label: "Total users",
          value: "121 M",
          icon: "fa-caret-up",
          variant: "success",
      ...
      <Row>
        <Col md={6} xl={3}>
          <StatisticsWidget2 variant="blue" description="Income status" stats="12145" icon="fe-aperture" progress={60} counterOptions={{
          prefix: "$"
        }} />
        </Col>
        <Col md={6} xl={3}>
          <StatisticsWidget2 variant="success" description="January's Sales" stats="1576" icon="fe-shopping-cart" progress={49} />
        </Col>
        <Col md={6} xl={3}>
          <StatisticsWidget2 variant="warning" description="Payouts" stats="8947" icon="fe-bar-chart-2" progress={18} />
        </Col>
        <Col md={6} xl={3}>
          <StatisticsWidget2 variant="info" description="Available Stores" stats="178" icon="fe-cpu" progress={74} />
        </Col>
      </Row>
      {/* StatisticsWidget4 */}
      <Row>
      ...
      <Row>
        <Col xl={4}>
          <StatisticsChartWidget icon="fe-aperture" variant="warning" stats="8145" description="Income Status" counterOptions={{
          prefix: "$"
        }} chartConfig={{
          apxOptions: {
            chart: {
        ...
        <Col xl={4}>
          <StatisticsChartWidget icon="fe-shopping-bag" variant="blue" stats="367" description="Sales Status" chartConfig={{
          apxOptions: {
            chart: {
              type: "line",
              height: 50,
        ...
        <Col xl={4}>
          <StatisticsChartWidget icon="fe-users" variant="success" stats="7204" description="Recent Users" chartConfig={{
          apxOptions: {
            chart: {
              type: "area",
              height: 50,
      ...
      <Row>
        ...
        <Col xl={4}>
          <StatisticsChartWidget2 title={"Recent Users"} color={"#1abc9c"} data={81} totalSales={"72"} target={"8k"} lastWeek={"2.5k"} lastMonth={"10.2k"} />
        </Col>
      </Row>
