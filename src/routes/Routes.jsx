    ...
    <React.Fragment>
      <Routes>
        ...
        {authProtectedFlattenRoutes.map((route, idx) => {
          ...
          return (
            <Route path={route.path} element={!isAuthenticated ? <Navigate to={{ pathname: "/", search: "next=" + route.path }} /> : <Layout {...props} tenantSlug={tenantSlug}>{route.element}</Layout>} key={idx} />
          );
        })}
